module forward_unit import rv32i_pkg::*; (
  ...
  always_comb begin
    if (ex_mem_reg_write_i && ex_mem_rd_i != 5'b0 && ex_mem_rd_i == id_ex_rs1_addr_i && ex_mem_result_src_i != RESULT_MEM)
    ...
    if (ex_mem_reg_write_i && ex_mem_rd_i != 5'b0 && ex_mem_rd_i == id_ex_rs2_addr_i && ex_mem_result_src_i != RESULT_MEM)
